 ...
 * @author Usuario
 */
public class Window_English extends javax.swing.JFrame {

    /**
     * Creates new form Window_English
     */
    public Window_English() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Click to the listen a letter:");
    ...
    private void AActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AActionPerformed
        ...
        List_EnglishLetters Eng = new List_EnglishLetters();
        
        try {
            Eng.listenLetterA();
        } catch (UnsupportedAudioFileException ex) {
            Logger.getLogger(Window_English.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Window_English.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
