 ...
 * @author Usuario
 */
public class Window_Spanish extends javax.swing.JFrame {

    /**
     * Creates new form Window_English
     */
    public Window_Spanish() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Clic para escuchar la letra del alfabeto:");
    ...
    private void AActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AActionPerformed
        ...
        List_SpanishLetters esp = new List_SpanishLetters();
        
        try {
            esp.escucharA();
        } catch (UnsupportedAudioFileException ex) {
            Logger.getLogger(Window_Spanish.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Window_Spanish.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
